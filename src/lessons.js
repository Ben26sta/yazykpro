...
export const LESSONS = {
  en: [
    ...
    {
      id:"en_a1_9", title:"Одежда и стиль", emoji:"👗", level:"A1", group:"Описание",
      description:"Одежда, цвета, стиль, шоппинг",
      theory:"Одежда: T-shirt-футболка, Shirt-рубашка, Jacket-куртка, Coat-пальто\nTrousers/Pants-брюки, Jeans-джинсы, Dress-платье, Skirt-юбка\nSocks-носки, Shoes-туфли, Boots-сапоги, Sneakers-кроссовки\nHat-шапка/шляпа, Scarf-шарф, Gloves-перчатки, Belt-ремень\n\nПокупки:\nWhat size are you? — Какой у вас размер?\nCan I try this on? — Можно примерить?\nIt fits me well — Мне подходит\nIt's too tight/loose — Слишком тесно/свободно\nHow much is it? — Сколько стоит?",
      words:[
        {word:"T-shirt",translation:"Футболка",example:"I wear a white T-shirt."},
        {word:"Jacket",translation:"Куртка",example:"Take your jacket, it's cold!"},
        {word:"Sneakers",translation:"Кроссовки",example:"My sneakers are comfortable."},
        {word:"Dress",translation:"Платье",example:"She wears a beautiful dress."},
      ],
      questions:[
        {type:"choice",q:"'Jacket' — это:",options:["Брюки","Куртка","Шарф","Шапка"],answer:"Куртка"},
        {type:"input",q:"Переведи: 'Джинсы'",answer:"jeans",hint:"jeans"},
        {type:"choice",q:"'Can I try this on?' означает:",options:["Это подходит?","Можно примерить?","Сколько стоит?","Какой размер?"],answer:"Можно примерить?"},
        {type:"input",q:"Как по-английски 'Кроссовки'?",answer:"sneakers",hint:"sneakers"},
        {type:"choice",q:"'It's too tight' означает:",options:["Слишком свободно","Слишком тесно","Отлично подходит","Слишком длинно"],answer:"Слишком тесно"},
        {type:"input",q:"Переведи: 'Шарф'",answer:"scarf",hint:"scarf"},
        {type:"choice",q:"'Boots' — это:",options:["Туфли","Сандалии","Сапоги","Тапочки"],answer:"Сапоги"},
        {type:"input",q:"Как по-английски 'Перчатки'?",answer:"gloves",hint:"gloves"},
        {type:"choice",q:"'It fits me well' означает:",options:["Слишком мало","Слишком велико","Мне подходит","Не мой стиль"],answer:"Мне подходит"},
        {type:"input",q:"Переведи: 'Платье'",answer:"dress",hint:"dress"},
        {type:"choice",q:"'Belt' — это:",options:["Ремень","Носки","Колготки","Подтяжки"],answer:"Ремень"},
        {type:"input",q:"Как спросить 'Сколько это стоит?'",answer:"how much is it",hint:"How much is it?"},
      ]
    },
    {
      id:"en_a1_10", title:"Природа и погода", emoji:"🌤️", level:"A1", group:"Природа",
      description:"Погода, природа, времена года",
      theory:"Погода: Sunny-солнечно, Rainy-дождливо, Cloudy-облачно, Windy-ветрено\nSnowy-снежно, Hot-жарко, Cold-холодно, Warm-тепло, Foggy-туманно\n\nПрирода: Mountain-гора, River-река, Sea-море, Forest-лес, Field-поле\nBeach-пляж, Island-остров, Lake-озеро, Desert-пустыня\n\nВремена года: Spring-весна, Summer-лето, Autumn/Fall-осень, Winter-зима\n\nФразы:\nWhat's the weather like? — Какая погода?\nIt's raining — Идёт дождь\nIt's snowing — Идёт снег\nI love summer! — Я люблю лето!",
      words:[
        {word:"Sunny",translation:"Солнечно",example:"It's sunny today!"},
        {word:"Rain",translation:"Дождь",example:"I love the rain."},
        {word:"Mountain",translation:"Гора",example:"The mountains are beautiful."},
        {word:"Beach",translation:"Пляж",example:"Let's go to the beach!"},
      ],
      questions:[
        {type:"choice",q:"'Rainy' означает:",options:["Солнечно","Дождливо","Облачно","Ветрено"],answer:"Дождливо"},
        {type:"input",q:"Переведи: 'Гора'",answer:"mountain",hint:"mountain"},
        {type:"choice",q:"'What's the weather like?' означает:",options:["Ты любишь погоду?","Какая погода?","Когда будет дождь?","Какой прогноз?"],answer:"Какая погода?"},
        {type:"input",q:"Как по-английски 'Море'?",answer:"sea",hint:"sea"},
        {type:"choice",q:"'It's snowing' означает:",options:["Идёт снег","Идёт дождь","Светит солнце","Дует ветер"],answer:"Идёт снег"},
        {type:"input",q:"Переведи: 'Лес'",answer:"forest",hint:"forest"},
        {type:"choice",q:"'Autumn' — это:",options:["Весна","Лето","Осень","Зима"],answer:"Осень"},
        {type:"input",q:"Как по-английски 'Пляж'?",answer:"beach",hint:"beach"},
        {type:"choice",q:"'Foggy' означает:",options:["Солнечно","Дождливо","Туманно","Ветрено"],answer:"Туманно"},
        {type:"input",q:"Переведи: 'Озеро'",answer:"lake",hint:"lake"},
        {type:"choice",q:"'Desert' — это:",options:["Пустыня","Лес","Поле","Остров"],answer:"Пустыня"},
        {type:"input",q:"Как сказать 'Идёт дождь'?",answer:"it's raining",hint:"It's raining"},
      ]
    },
    {
      id:"en_a2_4", title:"Эмоции и характер", emoji:"😊", level:"A2", group:"Люди",
      description:"Чувства, эмоции, описание характера",
      theory:"Эмоции: Happy-счастливый, Sad-грустный, Angry-злой, Surprised-удивлённый\nScared/Afraid-напуганный, Excited-взволнованный, Bored-скучающий\nProud-гордый, Jealous-завистливый, Confused-растерянный, Lonely-одинокий\n\nХарактер: Kind-добрый, Funny-смешной, Smart-умный, Brave-храбрый\nLazy-ленивый, Honest-честный, Patient-терпеливый, Creative-творческий\nShy-стеснительный, Generous-щедрый, Stubborn-упрямый\n\nФразы:\nI feel... — Я чувствую себя...\nAre you okay? — Ты в порядке?\nCheer up! — Не унывай!",
      words:[
        {word:"Happy",translation:"Счастливый",example:"I'm so happy today!"},
        {word:"Excited",translation:"Взволнованный/Воодушевлённый",example:"I'm excited about the trip!"},
        {word:"Kind",translation:"Добрый",example:"She is very kind."},
        {word:"Brave",translation:"Храбрый",example:"Be brave!"},
      ],
      questions:[
        {type:"choice",q:"'Sad' означает:",options:["Счастливый","Грустный","Злой","Удивлённый"],answer:"Грустный"},
        {type:"input",q:"Переведи: 'Я чувствую себя счастливым'",answer:"i feel happy",hint:"I feel happy"},
        {type:"choice",q:"'Excited' означает:",options:["Устал","Скучает","Взволнован","Напуган"],answer:"Взволнован"},
        {type:"input",q:"Как по-английски 'Честный'?",answer:"honest",hint:"honest"},
        {type:"choice",q:"'Shy' означает:",options:["Смелый","Ленивый","Стеснительный","Умный"],answer:"Стеснительный"},
        {type:"input",q:"Переведи: 'Не унывай!'",answer:"cheer up",hint:"Cheer up!"},
        {type:"choice",q:"'Generous' означает:",options:["Жадный","Щедрый","Терпеливый","Творческий"],answer:"Щедрый"},
        {type:"input",q:"Переведи: 'Ты в порядке?'",answer:"are you okay",hint:"Are you okay?"},
        {type:"choice",q:"'Stubborn' означает:",options:["Добрый","Умный","Упрямый","Честный"],answer:"Упрямый"},
        {type:"input",q:"Как по-английски 'Завистливый'?",answer:"jealous",hint:"jealous"},
        {type:"choice",q:"'Lonely' означает:",options:["Грустный","Одинокий","Злой","Скучающий"],answer:"Одинокий"},
        {type:"input",q:"Переведи: 'Она очень терпеливая'",answer:"she is very patient",hint:"She is very patient"},
      ]
    },
    {
      id:"en_a2_5", title:"Спорт и хобби", emoji:"⚽", level:"A2", group:"Досуг",
      description:"Спорт, увлечения, свободное время",
      theory:"Спорт: Football-футбол, Basketball-баскетбол, Tennis-теннис, Swimming-плавание\nCycling-езда на велосипеде, Running-бег, Yoga-йога, Boxing-бокс\nSkiing-лыжи, Surfing-сёрфинг, Volleyball-волейбол\n\nХобби: Reading-чтение, Cooking-готовка, Drawing-рисование\nPhotography-фотография, Gaming-компьютерные игры, Travelling-путешествия\nMusic-музыка, Dancing-танцы, Gardening-садоводство\n\nФразы:\nI play... — Я играю в...\nI go... — Я занимаюсь...\nMy hobby is... — Моё хобби — это...\nI'm into... — Я увлекаюсь...",
      words:[
        {word:"Swimming",translation:"Плавание",example:"I go swimming every day."},
        ...
        {word:"Travelling",translation:"Путешествия",example:"I love travelling!"},
      ],
      questions:[
        {type:"choice",q:"'I play tennis' означает:",options:["Я смотрю теннис","Я играю в теннис","Я люблю теннис","Я учу теннис"],answer:"Я играю в теннис"},
        {type:"input",q:"Переведи: 'Моё хобби — фотография'",answer:"my hobby is photography",hint:"My hobby is photography"},
        {type:"choice",q:"'I go swimming' означает:",options:["Я иду купаться","Я занимаюсь плаванием","Я умею плавать","Я был в бассейне"],answer:"Я занимаюсь плаванием"},
        {type:"input",q:"Как по-английски 'Рисование'?",answer:"drawing",hint:"drawing"},
        {type:"choice",q:"'I'm into gaming' означает:",options:["Я против игр","Я в игре","Я увлекаюсь играми","Я выхожу из игры"],answer:"Я увлекаюсь играми"},
        {type:"input",q:"Переведи: 'Езда на велосипеде'",answer:"cycling",hint:"cycling"},
        {type:"choice",q:"'Surfing' — это:",options:["Катание на лыжах","Сёрфинг","Плавание","Дайвинг"],answer:"Сёрфинг"},
        {type:"input",q:"Как сказать 'Я занимаюсь бегом каждое утро'?",answer:"i go running every morning",hint:"I go running every morning"},
        {type:"choice",q:"'Gardening' — это:",options:["Готовка","Садоводство","Танцы","Чтение"],answer:"Садоводство"},
        {type:"input",q:"Переведи: 'Я увлекаюсь музыкой'",answer:"i'm into music",hint:"I'm into music"},
        {type:"choice",q:"'Yoga' — это:",options:["Йога","Бокс","Борьба","Акробатика"],answer:"Йога"},
        {type:"input",q:"Как по-английски 'Волейбол'?",answer:"volleyball",hint:"volleyball"},
      ]
    },
    {
      id:"en_b2_4", title:"Репортажная речь", emoji:"📰", level:"B2", group:"Грамматика",
      description:"Reported Speech — косвенная речь",
      theory:"Reported Speech — передача чужих слов:\nПрямая → Косвенная (сдвиг времён):\n• Present Simple → Past Simple\n  'I work here' → He said he worked there.\n• Present Continuous → Past Continuous\n  'I'm working' → She said she was working.\n• Past Simple → Past Perfect\n  'I went' → He said he had gone.\n• Will → Would\n  'I'll help' → She said she would help.\n• Can → Could, May → Might\n\nМестоимения и наречия также меняются:\nI→he/she, my→his/her, here→there, now→then\nyesterday→the day before, tomorrow→the next day\n\nГлаголы: said, told, asked, explained, admitted, denied, promised",
      words:[
        {word:"Reported speech",translation:"Косвенная речь",example:"He said he was tired."},
        {word:"The next day",translation:"На следующий день",example:"She said she'd come the next day."},
        {word:"Deny",translation:"Отрицать/Отрицать",example:"He denied taking the money."},
      ],
      questions:[
        {type:"choice",q:"'I work here.' → He said he ___ there.",options:["works","worked","is working","had worked"],answer:"worked"},
        {type:"input",q:"Переведи: 'I'll call you.' → She said she...",answer:"she said she would call me",hint:"She said she would call me."},
        {type:"choice",q:"'I can swim.' → She said she ___ swim.",options:["can","could","would","might"],answer:"could"},
        {type:"input",q:"'I went to Paris.' → He said he...",answer:"he said he had gone to paris",hint:"He said he had gone to Paris."},
        {type:"choice",q:"'I'm working now.' → She said she ___ then.",options:["is working","was working","worked","had worked"],answer:"was working"},
        {type:"input",q:"'Come tomorrow!' → She told me to come...",answer:"the next day",hint:"the next day"},
        {type:"choice",q:"'I didn't take it.' → He denied ___ it.",options:["take","took","taking","taken"],answer:"taking"},
        {type:"input",q:"'I love you.' (he to her) → He told her he...",answer:"he told her he loved her",hint:"He told her he loved her."},
        {type:"choice",q:"'Here' в косвенной речи становится:",options:["here","there","then","now"],answer:"there"},
        {type:"input",q:"'I may be late.' → She said she...",answer:"she said she might be late",hint:"She said she might be late."},
        {type:"choice",q:"'It happened yesterday.' → She said it had happened...",options:["yesterday","the day after","the day before","before"],answer:"the day before"},
        {type:"input",q:"'Don't worry!' → He told me...",answer:"he told me not to worry",hint:"He told me not to worry."},
      ]
    },
  ],
  ...
  de: [
    ...
    {
      id:"de_a1_4", title:"Одежда и цвета", emoji:"👗", level:"A1", group:"Описание",
      description:"Kleidung — одежда, стиль, шоппинг",
      theory:"Одежда: das T-Shirt-футболка, das Hemd-рубашка, die Jacke-куртка\ndie Hose-брюки, die Jeans-джинсы, das Kleid-платье, der Rock-юбка\ndie Schuhe (мн.ч.)-обувь, die Socken-носки, der Mantel-пальто\ndie Mütze-шапка, der Schal-шарф, die Handschuhe-перчатки\n\nЦвета: rot-красный, blau-синий, grün-зелёный, gelb-жёлтый\nschwarz-чёрный, weiß-белый, grau-серый, lila-фиолетовый\n\nПокупки:\nWas kostet das? — Сколько стоит?\nKann ich das anprobieren? — Можно примерить?\nEs passt mir gut — Мне подходит\nZu groß/klein — Слишком большой/маленький",
      words:[
        {word:"die Jacke",translation:"Куртка",example:"Die Jacke ist warm."},
        {word:"das Kleid",translation:"Платье",example:"Das rote Kleid ist schön."},
        {word:"die Schuhe",translation:"Обувь/Туфли",example:"Neue Schuhe sind teuer."},
        {word:"der Schal",translation:"Шарф",example:"Ich brauche einen Schal."},
      ],
      questions:[
        {type:"choice",q:"'Die Hose' — это:",options:["Куртка","Брюки","Юбка","Платье"],answer:"Брюки"},
        {type:"input",q:"Как по-немецки 'Красный'?",answer:"rot",hint:"rot"},
        {type:"choice",q:"'Was kostet das?' означает:",options:["Что это?","Где это?","Сколько стоит?","Какой размер?"],answer:"Сколько стоит?"},
        {type:"input",q:"Переведи: 'Шарф' (с артиклем)",answer:"der schal",hint:"der Schal"},
        {type:"choice",q:"'Es passt mir gut' означает:",options:["Слишком мало","Слишком велико","Мне подходит","Не нравится"],answer:"Мне подходит"},
        {type:"input",q:"Как по-немецки 'Синий'?",answer:"blau",hint:"blau"},
        {type:"choice",q:"'Die Mütze' — это:",options:["Шарф","Перчатки","Шапка","Ремень"],answer:"Шапка"},
        {type:"input",q:"Переведи: 'Можно примерить?'",answer:"kann ich das anprobieren",hint:"Kann ich das anprobieren?"},
        {type:"choice",q:"'Schwarz' — это:",options:["Белый","Серый","Чёрный","Коричневый"],answer:"Чёрный"},
        {type:"input",q:"Как по-немецки 'Платье' (с артиклем)?",answer:"das kleid",hint:"das Kleid"},
        {type:"choice",q:"'Zu klein' означает:",options:["Слишком большой","Слишком маленький","Хорошо подходит","Слишком длинный"],answer:"Слишком маленький"},
        {type:"input",q:"Переведи: 'Носки'",answer:"socken",hint:"Socken"},
      ]
    },
    {
      id:"de_b2_2", title:"Wortschatz — продвинутая лексика", emoji:"📖", level:"B2", group:"Лексика",
      description:"Расширенный словарный запас для свободного общения",
      theory:"Полезные выражения:\n• Es kommt darauf an — Это зависит от...\n• Im Großen und Ganzen — В общем и целом\n• Unter Umständen — При определённых обстоятельствах\n• Meiner Meinung nach — По моему мнению\n• Einerseits... andererseits — С одной стороны... с другой\n• Es handelt sich um... — Речь идёт о...\n• Das liegt daran, dass... — Это объясняется тем, что...\n• Infolgedessen — Вследствие этого\n• Nichtsdestotrotz — Тем не менее\n• Im Nachhinein — Оглядываясь назад, постфактум",
      words:[
        {word:"Es kommt darauf an",translation:"Это зависит от...",example:"Es kommt darauf an, was du willst."},
        {word:"Meiner Meinung nach",translation:"По моему мнению",example:"Meiner Meinung nach ist das falsch."},
        {word:"Nichtsdestotrotz",translation:"Тем не менее",example:"Nichtsdestotrotz gehe ich hin."},
      ],
      questions:[
        {type:"choice",q:"'Meiner Meinung nach' означает:",options:["По всей видимости","По моему мнению","По общему мнению","Судя по всему"],answer:"По моему мнению"},
        {type:"input",q:"Переведи: 'С одной стороны... с другой'",answer:"einerseits andererseits",hint:"Einerseits... andererseits"},
        {type:"choice",q:"'Es kommt darauf an' означает:",options:["Это случилось","Это зависит от","Это важно","Это правда"],answer:"Это зависит от"},
        {type:"input",q:"Переведи: 'По моему мнению, это неправильно.'",answer:"meiner meinung nach ist das falsch",hint:"Meiner Meinung nach ist das falsch."},
        {type:"choice",q:"'Im Nachhinein' означает:",options:["Впоследствии/Постфактум","Заранее","В настоящее время","Одновременно"],answer:"Впоследствии/Постфактум"},
        {type:"input",q:"Переведи: 'Речь идёт о важной проблеме.'",answer:"es handelt sich um ein wichtiges problem",hint:"Es handelt sich um ein wichtiges Problem."},
        {type:"choice",q:"'Nichtsdestotrotz' — синоним:",options:["Следовательно","Тем не менее","Например","Кроме того"],answer:"Тем не менее"},
        {type:"input",q:"Переведи: 'В общем и целом всё хорошо.'",answer:"im großen und ganzen ist alles gut",hint:"Im Großen und Ganzen ist alles gut."},
        {type:"choice",q:"'Das liegt daran, dass...' означает:",options:["Несмотря на то что...","Это объясняется тем, что...","При условии что...","Хотя..."],answer:"Это объясняется тем, что..."},
        {type:"input",q:"Переведи: 'Вследствие этого цены выросли.'",answer:"infolgedessen sind die preise gestiegen",hint:"Infolgedessen sind die Preise gestiegen."},
        {type:"choice",q:"'Unter Umständen' означает:",options:["Ни при каких обстоятельствах","При определённых обстоятельствах","При всех обстоятельствах","Без обстоятельств"],answer:"При определённых обстоятельствах"},
        {type:"input",q:"Переведи: 'Это зависит от ситуации.'",answer:"es kommt auf die situation an",hint:"Es kommt auf die Situation an."},
      ]
    },
  ],
